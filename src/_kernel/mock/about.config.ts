export const aboutConfig = {
  header: {
    ...
    description:
      "Высокопроизводительное решение для трансляции RTSP потоков в браузер с ролевым управлением доступом и оптимизацией ресурсов",
  },
    ...
    items: [
      {
        ...
        description:
          "Автоматическое управление потоками - прекращение захвата при отсутствии зрителей",
      },
      {
        title: "Безопасность",
  ...
  cta: {
    ...
    content:
      "Разверните собственную систему видеонаблюдения с уникальной архитектурой и высокой производительностью.",
    buttons: [
      {
