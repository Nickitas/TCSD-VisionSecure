...
export const Footer: FC = () => {
  ...
  return (
    <footer className="w-full border-t py-5 border-default-200 bg-default-50/50">
      <div className="mx-auto max-w-7xl px-6 pt-12 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <span className="text-xl font-bold text-default-900">{siteConfig.name}</span>
            </div>
            <p className="text-sm text-default-600">{siteConfig.description}</p>
          ...
          <article>
            ...
            <address className="mt-4 not-italic text-default-600">
              ...
              <p className="mt-2 text-sm">{siteConfig.contacts.address}</p>
