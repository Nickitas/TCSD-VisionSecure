...
import { ArrowLeftIcon, CalendarIcon, EnvelopeIcon, LockClosedIcon, LockOpenIcon, PencilSquareIcon, PhoneIcon, ShieldCheckIcon, UserCircleIcon } from '@heroicons/react/24/outline';
                    ...
                    <Card className="dark:bg-[#f1f1f10c]  rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                        ...
                        <div className="border-t border-gray-200 dark:border-gray-700 p-4">
                            <div className="flex gap-2">
                                <Button color="success" variant='bordered' onPress={handleModalEdit} className="flex items-center gap-1">
                                    Редактировать
                                </Button>
                        ...
                        <Card className="dark:bg-[#f1f1f10c] rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Дата создания</p>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Последнее обновление</p>
